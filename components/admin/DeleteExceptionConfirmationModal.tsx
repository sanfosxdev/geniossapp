...
interface DeleteExceptionConfirmationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
const DeleteExceptionConfirmationModal: React.FC<DeleteExceptionConfirmationModalProps> = ({ isOpen, onClose, onConfirm, exceptionName }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-center p-4 animate-fade-in">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md transform animate-slide-in-up">
        ...
        <div className="p-6 text-center">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-300">¿Estás seguro de que quieres eliminar la excepción <strong className="dark:text-white">"{exceptionName}"</strong>?</p>
...
export default DeleteExceptionConfirmationModal;
