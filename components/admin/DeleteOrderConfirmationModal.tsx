...
const DeleteOrderConfirmationModal: React.FC<DeleteOrderConfirmationModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  orderId,
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md transform animate-slide-in-up">
        ...
        <div className="p-6 text-center">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-300">
                ¿Estás seguro de que quieres eliminar el pedido <strong className="dark:text-white">ID: {orderId.split('-')[1]}</strong>?
            </p>
