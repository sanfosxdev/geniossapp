...
interface DeleteCustomerCategoryConfirmationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  categoryName: string;
...
const DeleteCustomerCategoryConfirmationModal: React.FC<DeleteCustomerCategoryConfirmationModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  categoryName,
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md transform animate-slide-in-up">
        ...
        <div className="p-6 text-center">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-300">
                ¿Estás seguro de que quieres eliminar la categoría <strong className="dark:text-white">"{categoryName}"</strong>?
            </p>
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                Los clientes en esta categoría serán reasignados a la categoría "Nuevo".
            </p>
        </div>
...
export default DeleteCustomerCategoryConfirmationModal;
