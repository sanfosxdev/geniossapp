...
interface DeletePromotionConfirmationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
const DeletePromotionConfirmationModal: React.FC<DeletePromotionConfirmationModalProps> = ({ isOpen, onClose, onConfirm, promotionName }) => {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md transform animate-slide-in-up">
        ...
        <div className="p-6 text-center">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-300">
                ¿Estás seguro de que quieres eliminar la promoción <strong className="dark:text-white">"{promotionName}"</strong>?
            </p>
...
export default DeletePromotionConfirmationModal;
