...
const DeleteCategoryConfirmationModal: React.FC<DeleteCategoryConfirmationModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  categoryName,
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md transform animate-slide-in-up">
        ...
        <div className="p-6 text-center">
            ...
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                Esta acción no se puede deshacer. Los productos de esta categoría no serán eliminados.
            </p>
        </div>
